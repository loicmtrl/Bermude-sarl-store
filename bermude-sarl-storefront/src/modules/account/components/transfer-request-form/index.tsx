      ...
      <div className="grid sm:grid-cols-2 items-center gap-x-8 gap-y-4 w-full">
        <div className="flex flex-col gap-y-1">
          <Heading level="h3" className="text-lg text-neutral-950">
            Transfer de commande
          </Heading>
          <Text className="text-base-regular text-neutral-500">
            Impossible de trouver la commande que vous cherchez.
            <br /> Connecte une commande a ton compte.
          </Text>
        </div>
        <form
          action={formAction}
          ...
          <div className="flex gap-x-2 items-center">
            ...
            <div className="flex flex-col gap-y-1">
              <Text className="text-medim-pl text-neutral-950">
                Trandfer pour la commande {state.order?.id} demandé
              </Text>
              <Text className="text-base-regular text-neutral-600">
                Email de confirmation envoyé à {state.order?.email}
              </Text>
            </div>
          </div>
          <IconButton
